...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        // Calculate the new amount after deducting based on the weight (adjust the formula as needed)
        $newAmount = $currentAmount - ($weight * 2); // Assuming $2 per unit weight
        ...
        if ($conn->query($updateQuery) === TRUE) {
            ...
            echo "<script> alert(\"Laundry processed successfully! Your new amount is: $newAmount\"); </script>";
        } else {
...
<div class="w3-top w3-hide-small">
    <div class="w3-bar w3-xlarge w3-black w3-opacity w3-hover-opacity-off" id="myNavbar">
        ...
        <a href="signup.php" class="w3-bar-item w3-button">LOGIN</a>
...
<!-- Header with image -->
<div class="w3-container w3-padding-64 w3-blue-grey w3-grayscale-min w3-xlarge" id="myMap" style="height:100%;">
    <div class="w3-content">
      <h1 class="w3-center w3-jumbo" style="margin-bottom:64px">LAUNDRY</h1>
      ...
      <form action="#" method="post">
        ...
        <p><input class="w3-input w3-padding-16 w3-border" type="number" placeholder="Weight" id="Weight" name="Weight"></p>
