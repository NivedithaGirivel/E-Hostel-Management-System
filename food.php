...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $foodType = mysqli_real_escape_string($conn, $_POST["browser"]);
    ...
    if ($result->num_rows > 0) {
        ...
        // Determine the price based on food type (adjust these values as needed)
        $price = ($foodType === 'Veg') ? 10 : 15;

        // Check if the user has sufficient balance
        if ($currentAmount >= $price) {
            // Calculate the new amount after deducting the food price
...
<div class="w3-top w3-hide-small">
    <div class="w3-bar w3-xlarge w3-black w3-opacity w3-hover-opacity-off" id="myNavbar">
        ...
        <a href="#" class="w3-bar-item w3-button">MESS</a>
        <a href="laundry.php" class="w3-bar-item w3-button">LAUNDRY</a>
        <a href="store.php" class="w3-bar-item w3-button">STORE</a>
    </div>
</div>

<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xlarge" id="about" style="height:100%;">
    <div class="w3-content">
      <h1 class="w3-center w3-jumbo" style="margin-bottom:64px">FOOD</h1>
      <form action="#" method="post">
        ...
        <p><input list="browsers" name="browser" style="width: 100%;" placeholder="Veg/NonVeg">
